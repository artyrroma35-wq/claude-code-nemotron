...
class Settings(BaseSettings):
    ...
    mistral_api_keys: list[str] = Field(default_factory=list, validation_alias="MISTRAL_API_KEYS")
    mistral_text_model: str = Field(default="devstral-2512", validation_alias="MISTRAL_TEXT_MODEL")
    mistral_vision_model: str = Field(default="mistral-small-2603", validation_alias="MISTRAL_VISION_MODEL")
    mistral_ocr_model: str = Field(default="mistral-ocr-latest", validation_alias="MISTRAL_OCR_MODEL")

    # ==================== Gemini AI Config ====================
    gemini_api_key: str = Field(default="", validation_alias="GEMINI_API_KEY")
    gemini_text_model: str = Field(default="gemini-3.1-flash-lite", validation_alias="GEMINI_TEXT_MODEL")
    gemini_vision_model: str = Field(default="gemini-3.1-flash-lite", validation_alias="GEMINI_VISION_MODEL")
    ...
    pro_mode: bool = Field(default=True, validation_alias="PRO_MODE")
    pro_system_prompt: bool = Field(default=True, validation_alias="PRO_SYSTEM_PROMPT")
    multi_step_mode: bool = Field(default=False, validation_alias="MULTI_STEP_MODE")
    project_context: bool = Field(default=True, validation_alias="PROJECT_CONTEXT")

    pro_temperature: float = Field(default=0.62, validation_alias="PRO_TEMPERATURE")
    pro_top_p: float = Field(default=0.91, validation_alias="PRO_TOP_P")
    pro_reasoning_budget: int = Field(default=20000, validation_alias="PRO_REASONING_BUDGET")
